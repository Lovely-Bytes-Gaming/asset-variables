...
public class EnumVariableGenerator : EditorWindow
{
    ...
    private const string listener_src_path = "Assets/ScriptableVariables/Scripts/Editor/CodeGenerators/Templates/EnumListenerTemplate.txt";
    ...
    private const string listener_dest_path = "Assets/ScriptableVariables/Scripts/Classes/AutoGenerated/Listeners/{0}EnumListener.cs";
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("Generate Scripts"))
        {
            ...
            try
            {
                ...
                string listenerStr = string.Format(listenerTemplate, header, nameStr);
                ...
                file.Directory.Create();
                System.IO.File.WriteAllText(file.FullName, listenerStr);

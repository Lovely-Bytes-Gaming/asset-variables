...
{
    private const string script_template_path = "Assets/ScriptableVariables/Scripts/Editor/CodeGenerators/Templates/BitMaskVariableTemplate.txt";
    private const string editor_template_path = "Assets/ScriptableVariables/Scripts/Editor/CodeGenerators/Templates/BitMaskEditorTemplate.txt";
    private const string script_dest_path = "Assets/ScriptableVariables/Scripts/Classes/AutoGenerated/BitMasks/{0}BitMask.cs";

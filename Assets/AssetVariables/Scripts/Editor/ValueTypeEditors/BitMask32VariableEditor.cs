...
namespace LovelyBytesGaming.AssetVariables
{
    ...
    public class BitMask32VariableEditor : ValueTypeEditor<BitMask32>
    {
        ...
        protected override BitMask32 GenericEditorField(string description, BitMask32 value)
        {
            ...
            var valueAsFlags = (FlagsEnumerator)(int)value;
            BitMask32 newValue = (int)(FlagsEnumerator)EditorGUILayout.EnumFlagsField(valueAsFlags);
